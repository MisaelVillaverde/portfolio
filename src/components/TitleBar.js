          ...
          >
            <g id='Rangitikei'>
              <g transform='translate(0.000000, -100.000000)' id='Shape'>
                ...
                ></path>
                <path
                  d='M400,100 C400,155.228475 355.228475,200 300,200 C300,144.771525 344.771525,100 400,100 Z'
                  fill='#06818E'
                ></path>
                <path
                  d='M200,300 C200,244.771525 244.771525,200 300,200 C300,255.228475 255.228475,300 200,300 Z'
                  fill='#111747'
                ></path>
                <path
                ...
                ></path>
                <path
                  d='M800,300 C800,355.228475 755.228475,400 700,400 C700,344.771525 744.771525,300 800,300 Z'
                  fill='#111747'
                ></path>
                <path
                ...
                ></path>
                <path
                  d='M200,300 C200,355.228475 155.228475,400 100,400 C100,344.771525 144.771525,300 200,300 Z'
                  fill='#FFC641'
                ></path>
                <path
                ...
                ></path>
                <path
                  d='M0,900 C0,844.771525 44.771525,800 100,800 C100,855.228475 55.228475,900 0,900 Z'
                  fill='#16A3B2'
                ></path>
                <rect
                  fill='#06818E'
                ...
                ></path>
                <path
                  d='M0,500 C0,444.771525 44.771525,400 100,400 C100,455.228475 55.228475,500 0,500 Z'
                  fill='#06818E'
                ></path>
                <path
                  d='M600,700 C600,644.771525 644.771525,600 700,600 C700,655.228475 655.228475,700 600,700 Z'
                  fill='#FFFFFF'
                ></path>
                <path
                ...
                ></path>
                <path
                  d='M500,200 C500,144.771525 544.771525,100 600,100 C600,155.228475 555.228475,200 500,200 Z'
                  fill='#FE5E33'
                ></path>
                <rect
                  fill='#111747'
                ...
                ></path>
                <path
                  d='M900,800 C900,855.228475 855.228475,900 800,900 C800,844.771525 844.771525,800 900,800 Z'
                  fill='#06818E'
                ></path>
                <path
